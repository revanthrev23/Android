...
class MyFirebaseMessaging : FirebaseMessagingService(){
    ...
    private fun sendNotification(mRemoteMessage: RemoteMessage) {
        ...
        val builder : NotificationCompat.Builder? = NotificationCompat.Builder(this).setSmallIcon(icon!!.toInt()).setContentTitle(title).setContentText(body).setAutoCancel(true).setSound(defaultSound).setContentIntent(pendingIntent)
