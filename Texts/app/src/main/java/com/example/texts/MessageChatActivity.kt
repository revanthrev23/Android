...
import com.example.texts.AdapterClasses.ChatsAdapter
import com.example.texts.ModelClasses.Chat
import com.example.texts.ModelClasses.Users
import com.example.texts.Notifications.*
...
class MessageChatActivity : AppCompatActivity() {
    ...
    private fun sendMessageToUser(senderId: String, receiverId: String?, message: String) {
        ...
        messageHashMap["receiever"] = receiverId
            ...
            if(task.isSuccessful){
                ...
                chatListReference.addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        val chatListRecieverReference = FirebaseDatabase.getInstance().reference.child("ChatList").child(userIdVisit!!).child(firebaseUser!!.uid)
        ...
        if (requestCode == 438 && resultCode == RESULT_OK && data!=null && data.data!=null){
            ...
            uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                ...
                if (task.isSuccessful){
                    ...
                    messageHashMap["receiever"] = userIdVisit!!
                    messageHashMap["isSeen"] = false
    ...
    private fun retrieveMessages(senderId: String, receiverId: String?, receieverImageUrl: String?) {
        mChatList = ArrayList()
        ...
        reference!!.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for( snapshot in p0.children){
                    ...
                    if(chat!!.getReceiever().equals(senderId) && chat.getSender().equals(receiverId) || chat.getReceiever().equals(receiverId) && chat.getSender().equals(senderId)){
                        (mChatList as ArrayList<Chat>).add(chat)
                    }
                    ChatsAdapter = ChatsAdapter(this@MessageChatActivity, (mChatList as ArrayList<Chat>), receieverImageUrl!!)
                    Log.d("lol", "Messages added to adapter")
        ...
        seenListener = reference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                for (dataSnapshot in p0.children){
                    ...
                    if(chat!!.getReceiever().equals(firebaseUser!!.uid) && chat!!.getSender().equals(userId)){
